...
class SiteController extends Controller
{
	...
	public function actionIndex()
	{
		...
		if(Yii::app()->user->isGuest){
			...
			$this->redirect($this->createUrl('selectcompany'));
		}
	}
	...
	public function actionSelectCompany(){
		...
		if(isset($_POST['SelectCompanyForm']))
		{
			...
			if($model->validate()){ //TODO:validar si existe la empresa
				Yii::app()->user->setState('companyid',$model->company);  //ac� se settea el id de la empresa
	 ...
	 */
	public function actionLogin($lang = null)
	{
		if($lang!=null){
