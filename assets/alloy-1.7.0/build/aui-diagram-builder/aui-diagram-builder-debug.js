...
}, '1.7.0' ,{skinnable:true, requires:['aui-tabs','aui-property-list','collection','dd']});
...
}, '1.7.0' ,{skinnable:true, requires:['aui-base','aui-template','arraylist-add','arraylist-filter','json','graphics','dd']});


AUI.add('aui-diagram-builder', function(A){}, '1.7.0' ,{skinnable:true, use:['aui-diagram-builder-base','aui-diagram-builder-impl']});
