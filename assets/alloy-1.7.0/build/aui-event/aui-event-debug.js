...
}, '1.7.0' ,{condition: {name: 'aui-event-delegate-change', trigger: 'event-base-ie', ua: 'ie'}, requires:['aui-node-base','aui-event-base']});
...
}, '1.7.0' ,{condition: {name: 'aui-event-delegate-submit', trigger: 'event-base-ie', ua: 'ie'}, requires:['aui-node-base','aui-event-base']});


AUI.add('aui-event', function(A){}, '1.7.0' ,{skinnable:false, use:['aui-event-base','aui-event-input']});
