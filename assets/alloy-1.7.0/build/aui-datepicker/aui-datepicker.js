...
}, '1.7.0' ,{skinnable:true, requires:['aui-datatype','calendar','aui-overlay-context']});
...
}, '1.7.0' ,{skinnable:true, requires:['aui-datepicker-base','aui-button-item']});


AUI.add('aui-datepicker', function(A){}, '1.7.0' ,{use:['aui-datepicker-base','aui-datepicker-select'], skinnable:true});
