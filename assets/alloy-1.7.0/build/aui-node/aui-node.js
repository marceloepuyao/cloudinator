...
}, '1.7.0' ,{requires:['array-extras','aui-base-lang','aui-classnamemanager','node']});
...
}, '1.7.0' ,{requires:['collection','aui-base']});
...
}, '1.7.0' ,{requires:['aui-node-html5']});


AUI.add('aui-node', function(A){}, '1.7.0' ,{use:['aui-node-base','aui-node-html5','aui-node-html5-print'], skinnable:false});
