...
}, '1.7.0' ,{skinnable:true, requires:['aui-component','aui-state-interaction']});
...
}, '1.7.0' ,{requires:['aui-component','aui-state-interaction','aui-tabs-base','aui-overlay-context','plugin']});


AUI.add('aui-tabs', function(A){}, '1.7.0' ,{skinnable:true, use:['aui-tabs-base','aui-tabs-menu-plugin']});
