...
}, '1.7.0' ,{skinnable:false, requires:['aui-base','aui-task-manager']});
...
}, '1.7.0' ,{skinnable:false, requires:['aui-tree-data','aui-tree-io','aui-tree-paginator','json','querystring-stringify']});
...
}, '1.7.0' ,{skinnable:false, requires:['aui-base']});
...
}, '1.7.0' ,{skinnable:true, requires:['aui-tree-node','aui-tree-paginator','aui-tree-io','dd-delegate','dd-proxy']});
...
}, '1.7.0' ,{skinnable:false, requires:['aui-io','json']});


AUI.add('aui-tree', function(A){}, '1.7.0' ,{use:['aui-tree-data', 'aui-tree-node', 'aui-tree-io', 'aui-tree-paginator', 'aui-tree-view'], skinnable:true});
