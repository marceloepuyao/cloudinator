...
}, '1.7.0' ,{skinnable:true, requires:['anim','aui-overlay-mask']});
...
}, '1.7.0' ,{skinnable:true, requires:['aui-image-viewer-base','aui-paginator','aui-toolbar']});
...
}, '1.7.0' ,{skinnable:false, requires:['aui-image-viewer-base']});


AUI.add('aui-image-viewer', function(A){}, '1.7.0' ,{use:['aui-image-viewer-base','aui-image-viewer-gallery','aui-media-viewer-plugin'], skinnable:true});
