...
}, '1.7.0' ,{skinnable:true, requires:['aui-base','aui-button-item','aui-data-set','aui-diagram-builder-base','aui-nested-list','aui-tabs']});
...
}, '1.7.0' ,{skinnable:true, requires:['aui-datatype','aui-panel','aui-tooltip']});


AUI.add('aui-form-builder', function(A){}, '1.7.0' ,{use:['aui-form-builder-base','aui-form-builder-field'], skinnable:true});
