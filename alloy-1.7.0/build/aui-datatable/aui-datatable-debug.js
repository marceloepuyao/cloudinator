...
}, '1.7.0' ,{skinnable:true, requires:['datatable-base','calendar','aui-datatype','aui-toolbar','aui-form-validator','overlay','sortable']});
...
}, '1.7.0' ,{skinnable:true, requires:['datatable-base']});
...
}, '1.7.0' ,{skinnable:true, requires:['aui-datatable-selection']});


AUI.add('aui-datatable', function(A){}, '1.7.0' ,{use:['aui-datatable-edit','aui-datatable-selection','aui-datatable-highlight'], skinnable:true});
